#!/bin/bash
#SBATCH --job-name=sift1m_vdt_s99
...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/sift1m/sift1m_vdt_s99_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/sift1m/sift1m_vdt_s99_%j.err

# SIFT1M VDTuner (EHVI multi-objective BO) — 50 iterations, seed=42

SEED=99
PORT=55707
INSTANCE="vdms_sift1m_vdt_s99_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_sift1m_vdt_s99_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_sift1m_vdt_s99_${SLURM_JOB_ID}.json"
SNAP_KEY_FILE="/tmp/vdms_snap_key_sift1m_vdt_s99_${SLURM_JOB_ID}.txt"
VDMS_PARAMS_FILE="/tmp/vdms_params_sift1m_vdt_s99_${SLURM_JOB_ID}.json"
OUTPUT="${BASE_DIR}/supplementary/results/sift1m/vdtuner/seed99.json"
...
"
    ...
    apptainer exec instance://${INSTANCE} \
        /vdms/build/vdms -cfg "$VDMS_CFG" > /tmp/vdms_sift1m_vdt_s99_${SLURM_JOB_ID}.log 2>&1 &
