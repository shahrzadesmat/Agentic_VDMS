#!/bin/bash
#SBATCH --job-name=hico_opt_r_s42
...
#SBATCH --output=hico_det/hico_opt_r_s42_%j.log
#SBATCH --error=hico_det/hico_opt_r_s42_%j.err

export OPENROUTER_API_KEY="${OPENROUTER_API_KEY:-YOUR_KEY_HERE}"

PORT=55634
INSTANCE="vdms_opt_r_s42_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_opt_r_s42_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_opt_r_s42_${SLURM_JOB_ID}.json"
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_opt_r_s42_${SLURM_JOB_ID}.log 2>&1 &
