#!/bin/bash
#SBATCH --job-name=hico_rand_r_s200
...
#SBATCH --output=hico_det/hico_rand_r_s200_%j.log
#SBATCH --error=hico_det/hico_rand_r_s200_%j.err

export OPENROUTER_API_KEY="${OPENROUTER_API_KEY:-YOUR_KEY_HERE}"

PORT=55639
INSTANCE="vdms_rand_r_s200_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_rand_r_s200_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_rand_r_s200_${SLURM_JOB_ID}.json"
FINAL_RESULTS="/work/hdd/bdjd/vdms_workflow/semantic_vdms/FINAL_RESULTS/hico_det/results"
OUTPUT="${FINAL_RESULTS}/random_seed200.json"

echo "===== Random search rerun seed=200 ====="
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_rand_r_s200_${SLURM_JOB_ID}.log 2>&1 &
