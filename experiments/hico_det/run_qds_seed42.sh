#!/bin/bash
#SBATCH --job-name=hico_qds_std_s42
...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/hico_det/hico_qds_std_s42_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/hico_det/hico_qds_std_s42_%j.err
...
INSTANCE="vdms_qds_std_s42_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_qds_std_s42_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_qds_std_s42_${SLURM_JOB_ID}.json"
FINAL_RESULTS="${BASE_DIR}/FINAL_RESULTS/hico_det/results"
OUTPUT="${FINAL_RESULTS}/llm_qds_standard_seed42.json"

echo "=================================================="
echo "HICO-DET LLM+QDS — standard threshold, seed=42"
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_qds_std_s42_${SLURM_JOB_ID}.log 2>&1 &
