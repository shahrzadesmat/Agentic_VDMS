...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/hico_det/hico_vdt_s200_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/hico_det/hico_vdt_s200_%j.err
...
SEED=200
PORT=55702
INSTANCE="vdms_hico_vdt_s200_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_hico_vdt_s200_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_hico_vdt_s200_${SLURM_JOB_ID}.json"
OUTPUT="${BASE_DIR}/supplementary/results/hico_det/vdtuner/seed200.json"
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_hico_vdt_s200_${SLURM_JOB_ID}.log 2>&1 &
