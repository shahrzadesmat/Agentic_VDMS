...
SEED=42
PORT=55700
INSTANCE="vdms_hico_vdt_s42_${SLURM_JOB_ID}"
DB_ROOT="/tmp/vdms_hico_vdt_s42_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_hico_vdt_s42_${SLURM_JOB_ID}.json"
OUTPUT="${BASE_DIR}/supplementary/results/hico_det/vdtuner/seed42.json"
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_hico_vdt_s42_${SLURM_JOB_ID}.log 2>&1 &
