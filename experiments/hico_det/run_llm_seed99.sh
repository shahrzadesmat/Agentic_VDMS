#!/bin/bash
#SBATCH --job-name=hico_llm_r_s99
...
#SBATCH --output=hico_det/hico_llm_r_s99_%j.log
#SBATCH --error=hico_det/hico_llm_r_s99_%j.err
...
PORT=55631
INSTANCE="vdms_llm_r_s99_${SLURM_JOB_ID}"
DB_ROOT="/tmp/vdms_llm_r_s99_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_llm_r_s99_${SLURM_JOB_ID}.json"
FINAL_RESULTS="${BASE_DIR}/FINAL_RESULTS/hico_det/results"
OUTPUT="${FINAL_RESULTS}/llm_seed99.json"

echo "===== LLM agent rerun seed=99 ====="
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_llm_r_s99_${SLURM_JOB_ID}.log 2>&1 &
