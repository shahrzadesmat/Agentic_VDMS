...
#SBATCH --output=/path/to/Agentic_VDMS/eci/logs/hico_eci_s42_%j.log
#SBATCH --error=/path/to/Agentic_VDMS/eci/logs/hico_eci_s42_%j.err
#
...
#
# Usage: sbatch run_eci_seed42.sh
