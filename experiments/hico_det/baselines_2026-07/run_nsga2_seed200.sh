#!/bin/bash
#SBATCH --job-name=hico_nsga2_s200
...
#SBATCH --output=/path/to/Agentic_VDMS/eci/logs/hico_nsga2_s200_%j.log
#SBATCH --error=/path/to/Agentic_VDMS/eci/logs/hico_nsga2_s200_%j.err
#
