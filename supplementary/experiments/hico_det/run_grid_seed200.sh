#!/bin/bash
#SBATCH --job-name=hico_grid_s200
...
#SBATCH --output=hico_det/hico_grid_s200_%j.log
#SBATCH --error=hico_det/hico_grid_s200_%j.err

PORT=55642
INSTANCE="vdms_grid_s200_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_grid_s200_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_grid_s200_${SLURM_JOB_ID}.json"
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_grid_s200_${SLURM_JOB_ID}.log 2>&1 &
