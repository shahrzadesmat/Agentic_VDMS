...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/gldv2/gldv2_random_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/gldv2/gldv2_random_%j.err

# GLDv2 Random Search Baseline — 30 iters, seed=42
# Score: mAP × QPS

SEED=42
PORT=55600
INSTANCE="vdms_gldv2_random"
...
DB_ROOT="/tmp/vdms_gldv2_random_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_gldv2_random_${SLURM_JOB_ID}.json"
OUTPUT="gldv2/gldv2_random_seed${SEED}_results_${SLURM_JOB_ID}.json"

echo "========================================="
echo "GLDv2 Random Search Baseline"
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        /vdms/build/vdms -cfg "$VDMS_CFG" > /tmp/vdms_gldv2_random_${SLURM_JOB_ID}.log 2>&1 &
    ...
    if [ $? -ne 0 ]; then
        ...
        cat /tmp/vdms_gldv2_random_${SLURM_JOB_ID}.log
