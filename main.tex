...
\label{tab:baselines}
\normalsize % <--- Matches your main paragraph text size
\setlength{\tabcolsep}{2pt} % <--- Maximum squish to fit the large font
\begin{tabular}{p{3.8cm}lcccccccccc}
\toprule
\textbf{Method} & \textbf{$\alpha$} & \textbf{$k$} & \textbf{mAP} & \textbf{P@10} & \textbf{NDCG@10} & \textbf{R@10} & \textbf{QPS} & \textbf{Build (s)} & \textbf{CLIP (ms)} & \textbf{DINO (ms)} & \textbf{Score} \\
\midrule
...
DINOv2 ViT-L/14-reg4 (Flat)               & 1.0 & 2000 & 0.2165 & 0.3232 & 0.3472 & 0.0800 & 1.16 & 432.9 & 851.6 & 5.18 & 0.250 \\
CLIP + DINOv2 rerank (Flat)               & 0.5 & 2000 & \textbf{0.2763} & \textbf{0.3812} & \textbf{0.4150} & \textbf{0.1138} & 1.15 & 430.1 & 855.2 & 4.82 & 0.319 \\
\bottomrule
\end{tabular}
\end{table*}
...
\label{tab:optimizer}
\normalsize % Keeps your large, readable text
\setlength{\tabcolsep}{2pt} % Keeps columns snug
\begin{tabular}{lccccccccccc} % <--- Changed p{3.8cm} back to 'l' so it hugs the text tightly!
\toprule
\textbf{Method} & \textbf{Score}$\uparrow$ & \textbf{mAP}$\uparrow$ & \textbf{P@10}$\uparrow$ & \textbf{NDCG@10}$\uparrow$ & \textbf{R@10}$\uparrow$ & \textbf{QPS}$\uparrow$ & \textbf{Build(s)}$\downarrow$ & \textbf{CLIP(ms)}$\downarrow$ & \textbf{DINO(ms)}$\downarrow$ & \textbf{Lat(ms)}$\downarrow$ & \textbf{Iters} \\
\midrule
Grid Search$^\dagger$
