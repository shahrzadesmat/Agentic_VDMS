...
annotated with bounding boxes and interaction labels across 600 HOI categories, each
structured as a \emph{verb--object} pair drawn from 117 action verbs and 80 MS-COCO
object classes.
Every published use of HICO-DET has been restricted to the detection paradigm:
predicting bounding boxes and interaction class labels from a given image.
We repurpose its annotation structure to define the first HOI retrieval benchmark on
HICO-DET.
...
All image embeddings are 512-dimensional CLIP ViT-L/14 vectors stored in VDMS.
