...
\begin{table*}[t]
\centering
\caption{Brute-force baselines on HICO-DET (47,776 images, FaissFlat exact search, all measured in our VDMS setup).
  ...
  The UniIR~\cite{uniir} system reports mAP$=$0.2461 with CLIP ViT-L/14 at $k{=}10$ but does not provide throughput numbers.}
\label{tab:baselines}
\footnotesize
\setlength{\tabcolsep}{5pt}
\begin{tabular}{llcccccccccc}
\toprule
\textbf{Method} & \textbf{$\alpha$} & \textbf{$k$} & \textbf{mAP} & \textbf{P@10} & \textbf{NDCG@10} & \textbf{QPS} & \textbf{Build (s)} & \textbf{CLIP (ms)} & \textbf{DINOv2 (ms)} & \textbf{Total Lat.\ (ms)} & \textbf{Score} \\
\midrule
CLIP ViT-L/14 (FaissFlat)                 & 0.0 & 500  & 0.2079 & 0.3370 & 0.3686 & 8.21 & 433.3 & 121.0 & 0.03 & 121.8 & 1.707 \\
CLIP ViT-L/14 (FaissFlat)                 & 0.0 & 2000 & 0.2398 & 0.3370 & 0.3686 & 1.17 & 431.2 & 850.0 & 0.09 & 855.8 & 0.280 \\
DINOv2 ViT-L/14-reg4 (FaissFlat)         & 1.0 & 2000 & 0.2165 & 0.3232 & 0.3472 & 1.16 & 432.9 & 851.6 & 5.18 & 865.1 & 0.250 \\
CLIP + DINOv2 rerank (FaissFlat)          & 0.5 & 2000 & \textbf{0.2763} & \textbf{0.3812} & \textbf{0.4150} & 1.15 & 430.1 & 855.2 & 4.82 & 866.0 & 0.319 \\
\bottomrule
\end{tabular}
\end{table*}
...
\caption{Comparison of ANN index hyperparameter optimization methods on HICO-DET (30 iterations, best config reported).
  ...
  Our LLM agent achieves the highest Score and converges $4\times$ faster than Optuna and Random Search.}
\label{tab:optimizer}
\footnotesize
...
\textbf{LLM Agent (Ours)}
  & \textbf{4.337} & 0.255 & 0.489 & 0.564 & 0.168 & \textbf{16.98} & 441.8 & \textbf{58.2} & \textbf{0.49} & \textbf{58.9} & \textbf{7/30} \\
\bottomrule
\end{tabular}
\end{table*}
