...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/gldv2/gldv2_opt_s99_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/gldv2/gldv2_opt_s99_%j.err
...
OUTPUT="${RESULTS_ROOT}/gldv2/optuna/seed99.json"
