...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/gldv2/gldv2_gpbo50_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/gldv2/gldv2_gpbo50_%j.err

# GLDv2 GP-BO — 50 iterations (rerun to match LLM/Random/Optuna budget), seed42 only

PORT=55626
SEED=42
INSTANCE="vdms_gldv2_gpbo50"
...
DB_ROOT="/tmp/vdms_gldv2_gpbo50_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_gldv2_gpbo50_${SLURM_JOB_ID}.json"
FINAL_RESULTS="${BASE_DIR}/FINAL_RESULTS/gldv2/results"
OUTPUT="${FINAL_RESULTS}/gpbo_seed42.json"

echo "========================================="
echo "GLDv2 GP-BO — 50 iterations, seed42"
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        /vdms/build/vdms -cfg "$VDMS_CFG" > /tmp/vdms_gldv2_gpbo50_${SLURM_JOB_ID}.log 2>&1 &
    ...
    if [ $? -ne 0 ]; then
        ...
        cat /tmp/vdms_gldv2_gpbo50_${SLURM_JOB_ID}.log
