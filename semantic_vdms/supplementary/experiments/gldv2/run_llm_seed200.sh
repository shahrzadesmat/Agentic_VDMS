#!/bin/bash
#SBATCH --job-name=gldv2_llm_s200
...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/gldv2/gldv2_llm_s200_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/gldv2/gldv2_llm_s200_%j.err

# GLDv2 LLM — 50 iterations, seed=200
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        /vdms/build/vdms -cfg "$VDMS_CFG" > /tmp/vdms_gldv2_llm_s200_${SLURM_JOB_ID}.log 2>&1 &
    ...
    if [ $? -ne 0 ]; then
        ...
        cat /tmp/vdms_gldv2_llm_s200_${SLURM_JOB_ID}.log
