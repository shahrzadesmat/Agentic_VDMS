#!/bin/bash
#SBATCH --job-name=hico_llm_cB_s99
...
#SBATCH --output=hico_det/conditionB/hico_llm_cB_s99_%j.log
#SBATCH --error=hico_det/conditionB/hico_llm_cB_s99_%j.err
...
PORT=55671
INSTANCE="vdms_llm_cB_s99_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_llm_cB_s99_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_llm_cB_s99_${SLURM_JOB_ID}.json"
RESULTS_BASE="/work/hdd/bdjd/vdms_workflow/semantic_vdms/supplementary/results/hico_det_condB"
OUTPUT="${RESULTS_BASE}/llm/seed99.json"

echo "===== HICO-DET LLM ConditionB seed=99 ====="
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_llm_cB_s99_${SLURM_JOB_ID}.log 2>&1 &
