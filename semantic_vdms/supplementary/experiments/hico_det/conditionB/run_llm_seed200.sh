#!/bin/bash
#SBATCH --job-name=hico_llm_cB_s200
...
#SBATCH --output=hico_det/conditionB/hico_llm_cB_s200_%j.log
#SBATCH --error=hico_det/conditionB/hico_llm_cB_s200_%j.err
...
PORT=55672
INSTANCE="vdms_llm_cB_s200_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_llm_cB_s200_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_llm_cB_s200_${SLURM_JOB_ID}.json"
RESULTS_BASE="/work/hdd/bdjd/vdms_workflow/semantic_vdms/supplementary/results/hico_det_condB"
OUTPUT="${RESULTS_BASE}/llm/seed200.json"

echo "===== HICO-DET LLM ConditionB seed=200 ====="
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_llm_cB_s200_${SLURM_JOB_ID}.log 2>&1 &
