#!/bin/bash
#SBATCH --job-name=hico_rand_cB_s200
...
#SBATCH --output=hico_det/conditionB/hico_rand_cB_s200_%j.log
#SBATCH --error=hico_det/conditionB/hico_rand_cB_s200_%j.err
...
PORT=55676
INSTANCE="vdms_rand_cB_s200_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_rand_cB_s200_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_rand_cB_s200_${SLURM_JOB_ID}.json"
RESULTS_BASE="/work/hdd/bdjd/vdms_workflow/semantic_vdms/supplementary/results/hico_det_condB"
OUTPUT="${RESULTS_BASE}/random/seed200.json"

echo "===== HICO-DET Random ConditionB seed=200 ====="
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_rand_cB_s200_${SLURM_JOB_ID}.log 2>&1 &
