...
#SBATCH --array=0-2
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/hico_det/hico_ablation_no_history_no_phases_%a_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/hico_det/hico_ablation_no_history_no_phases_%a_%j.err
...
echo "  Seed: $SEED  Port: $PORT  Array: $IDX"
