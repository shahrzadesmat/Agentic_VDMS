#!/bin/bash
#SBATCH --job-name=hico_llm_r_s200
...
#SBATCH --output=hico_det/hico_llm_r_s200_%j.log
#SBATCH --error=hico_det/hico_llm_r_s200_%j.err

export OPENROUTER_API_KEY=YOUR_OPENROUTER_API_KEY

PORT=55632
INSTANCE="vdms_llm_r_s200_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_llm_r_s200_${SLURM_JOB_ID}"
VDMS_CFG="/tmp/vdms_llm_r_s200_${SLURM_JOB_ID}.json"
FINAL_RESULTS="/work/hdd/bdjd/vdms_workflow/semantic_vdms/FINAL_RESULTS/hico_det/results"
OUTPUT="${FINAL_RESULTS}/llm_seed200.json"

echo "===== LLM agent rerun seed=200 ====="
...
start_vdms() {
    ...
    apptainer exec instance://${INSTANCE} \
        ...
        > /tmp/vdms_llm_r_s200_${SLURM_JOB_ID}.log 2>&1 &
