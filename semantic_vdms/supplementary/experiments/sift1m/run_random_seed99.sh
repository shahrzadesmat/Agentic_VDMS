#!/bin/bash
#SBATCH --job-name=sift1m_rand_s99
...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/sift1m/sift1m_rand_s99_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/sift1m/sift1m_rand_s99_%j.err

# SIFT1M RANDOM — 50 iterations, seed=99

export OPENROUTER_API_KEY="${OPENROUTER_API_KEY:-YOUR_KEY_HERE}"

SEED=99
PORT=55692
INSTANCE="vdms_sift1m_rand_s99_${SLURM_JOB_ID}"
...
DB_ROOT="/tmp/vdms_sift1m_rand_s99_${SLURM_JOB_ID}"
...
"
    ...
    apptainer exec instance://${INSTANCE} \
        /vdms/build/vdms -cfg "$VDMS_CFG" > /tmp/vdms_sift1m_rand_s99_${SLURM_JOB_ID}.log 2>&1 &
