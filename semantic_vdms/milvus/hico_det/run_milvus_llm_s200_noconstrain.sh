#!/bin/bash
#SBATCH --job-name=milvus_llm_s200_nc
...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/hico_det/logs/milvus_llm_s200_nc_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/hico_det/logs/milvus_llm_s200_nc_%j.err
...
echo "=== Milvus HICO-DET LLM Optimizer (seed=200, force constraint=none) ==="
...
$PYTHON $SRC/milvus_hico_optimizer.py \
    ...
    --output        $RESULTS/milvus_llm_s200_noconstraint.json
