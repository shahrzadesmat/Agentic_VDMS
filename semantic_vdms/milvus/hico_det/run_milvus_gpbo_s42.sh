...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/hico_det/logs/milvus_gpbo_s42_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/hico_det/logs/milvus_gpbo_s42_%j.err
...
echo "=== Milvus HICO-DET gpbo seed=42 ===" && date
