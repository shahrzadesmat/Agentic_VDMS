#!/bin/bash
#SBATCH --job-name=milvus_llm_s99_nc
...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/hico_det/logs/milvus_llm_s99_nc_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/hico_det/logs/milvus_llm_s99_nc_%j.err
...
echo "=== Milvus HICO-DET LLM Optimizer (seed=99, force constraint=none) ==="
...
$PYTHON $SRC/milvus_hico_optimizer.py \
    ...
    --output        $RESULTS/milvus_llm_s99_noconstraint.json
