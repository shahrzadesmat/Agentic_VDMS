...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/gldv2/logs/gldv2_optuna_s99_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/gldv2/logs/gldv2_optuna_s99_%j.err
