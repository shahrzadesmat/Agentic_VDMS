#!/bin/bash
#SBATCH --job-name=mil_gldv_vdtuner_s42
...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/gldv2/logs/gldv2_vdtuner_s42_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/gldv2/logs/gldv2_vdtuner_s42_%j.err
