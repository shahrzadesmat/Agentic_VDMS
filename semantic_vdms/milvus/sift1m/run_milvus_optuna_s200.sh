#!/bin/bash
#SBATCH --job-name=mil_sift_optuna_s200
...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/sift1m/logs/sift1m_optuna_s200_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/sift1m/logs/sift1m_optuna_s200_%j.err
