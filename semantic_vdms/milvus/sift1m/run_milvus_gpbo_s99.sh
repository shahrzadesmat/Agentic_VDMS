...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/sift1m/logs/sift1m_gpbo_s99_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/sift1m/logs/sift1m_gpbo_s99_%j.err
...
/work/hdd/bdjd/vdms_code/venv/bin/python /work/hdd/bdjd/vdms_workflow/src/milvus/milvus_sift1m_optimizer.py \
    ...
    --output      /work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/sift1m/results/milvus_gpbo_s99.json
