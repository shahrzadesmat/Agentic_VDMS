#!/bin/bash
#SBATCH --job-name=mil_sift_llm_s42
...
#SBATCH --output=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/sift1m/logs/sift1m_llm_s42_%j.log
#SBATCH --error=/work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/sift1m/logs/sift1m_llm_s42_%j.err
...
echo "=== Milvus SIFT1M llm seed=42 ===" && date
...
/work/hdd/bdjd/vdms_code/venv/bin/python /work/hdd/bdjd/vdms_workflow/src/milvus/milvus_sift1m_optimizer.py \
    ...
    --output      /work/hdd/bdjd/vdms_workflow/semantic_vdms/milvus/sift1m/results/milvus_llm_s42.json
